...
import { listaCandidatosSenadoresDistritoMultiple } from '@mock-api/candidatos-senadores-distrito-multiple';
...
export class CandidatosSenadoresDistritoMultipleService {
    getAll(): Observable<Response<CandidatoRequest[]>> {
        ...
        const candidatos = cloneDeep(listaCandidatosSenadoresDistritoMultiple);
