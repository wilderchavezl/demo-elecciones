...
import { listaCandidatosDiputados } from '@mock-api/candidatos-diputados';
...
export class CandidatosDiputadosService {
    getAll(): Observable<Response<CandidatoRequest[]>> {
        ...
        const candidatos = cloneDeep(listaCandidatosDiputados);
