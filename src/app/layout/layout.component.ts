...
import { THEME_VERSION } from '@theme/version/theme-version';
...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _themeMediaWatcherService: ThemeMediaWatcherService,
        private _themePlatformService: ThemePlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            ...
            this._themeMediaWatcherService.onMediaQueryChange$([
        ...
        this._themeConfigService.config$.pipe(takeUntil(this._unsubscribeAll)).subscribe((config: ThemeConfig) => {
            // Store the config
            this.config = config;
