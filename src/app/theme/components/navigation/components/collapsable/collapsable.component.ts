...
@Component({
    selector: 'theme-navigation-collapsable-item',
    ...
    imports: [
        ...
        forwardRef(() => ThemeNavigationCollapsableItemComponent),
        ThemeNavigationDividerItemComponent,
        ThemeNavigationGroupItemComponent,
        ThemeNavigationSpacerItemComponent,
    ],
})
export class ThemeNavigationCollapsableItemComponent implements OnInit, OnDestroy {
    ...
    @HostBinding('class') get classList(): any {
        return {
            'theme-navigation-item-collapsed': this.isCollapsed,
            'theme-navigation-item-expanded': this.isExpanded,
        };
    }
    ...
    ngOnInit(): void {
        ...
        this._themeNavigationComponent.onCollapsableItemCollapsed
        ...
        if (this.autoCollapse) {
            this._themeNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void {
        ...
        this._themeNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void {
        ...
        // Execute the observable
        this._themeNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
