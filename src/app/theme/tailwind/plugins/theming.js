            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `theme.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `theme.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--theme-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--theme-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
